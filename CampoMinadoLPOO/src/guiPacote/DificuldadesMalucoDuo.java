...
public class DificuldadesMalucoDuo extends JFrame implements ActionListener {
	...
	public DificuldadesMalucoDuo() {
		...
		JLabel label = new JLabel("Campo Minado Maluco (DUO)");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == easyButton) {
			dispose();
			new CampoMalucoGUIduo(escolherDificuldade(0));
		}

		if (e.getSource() == mediumButton) {
			dispose();
			new CampoMalucoGUIduo(escolherDificuldade(1));
		}

		if (e.getSource() == hardButton) {
			dispose();
			new CampoMalucoGUIduo(escolherDificuldade(2));
		}
